...
import { removeCircleOutline, createOutline } from "ionicons/icons";

export const DeleteSeuil = ({ id, onDelete }) => {
  let userEmail;
  ...
  const handleDelete = async () => {
    try {
      ...
      console.error("Error deleting seuil:", error);
    }
  };
  //
